...
# Переменные / функции
bot_token = '1320984965:AAHv9Smt28ALEEPQnmoIqLRBGBnDalsUS5Y'		# 
admin_user_id = 1414177063  											#  
channel_id = 1445045334											# 

token = '937e8adc28539df278a6643cccbff5bc' 							# qiwi token
phone = '79088923127'												# qiwi number

secret = 'd6d97f879fab5cee93ca37e3342593ece2b01ca7'   # CRYSTAL PAY SECRET 1
login = 'prsnv1'    # CRYSTAL PAY LOGIN


manager = "hqdhelper" # username мэнеджера без @
group = "@otziv_vaper" # канал с отзывами, готовый вариант, можно оставить

bot_name = "vapehqdbot" #username бота без @
